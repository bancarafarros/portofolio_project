<div class="container-fluid py-4">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo base_url('cv/CExperience/fungsiTambah') ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="resignated_date" class="form-control">
                                </div>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a href="<?php echo base_url('cv/CExperience/fungsiDelete/' . $edu->id) ?>" class="btn btn-danger ">Hapus</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        function deleteConfirm(id) {
            ...
            button.href = "<?= base_url('cv/CExperience/fungsiDelete/') ?>" + id;
            console.log(button);
            myModal.toggle();
        }
    </script>
    ...
    <script>
        $(document).ready(function() {
            $('#table').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?= site_url('cv/CExperience/dataTable') ?>",
                    type: "POST"
                },
                ...
                "columnDefs": [{
                    ...
                    "render": function(data, type, row, meta) {
                        return '<a class="btn btn-warning me-3" href="<?= base_url('cv/CExperience/halamanUpdate/') ?>' + row.id + '"><i class="fa fa-edit"></i></a>' +
