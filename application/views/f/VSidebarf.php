                ...
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="index.html">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="<?php echo base_url('assets/flexy/assets/images/logo-icon.png') ?>" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="<?php echo base_url('assets/flexy/assets/images/logo-light-icon.png') ?>" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                            <!-- dark Logo text -->
                            <img src="<?php echo base_url('assets/flexy/assets/images/logo-text.png') ?>" alt="homepage" class="dark-logo" />
                            <!-- Light Logo text -->
                            <img src="<?php echo base_url('assets/flexy/assets/images/logo-light-text.png') ?>" class="light-logo" alt="homepage" />
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
                    ...
                    <ul class="navbar-nav float-end">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark pro-pic" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="<?php echo base_url('assets/flexy/assets/images/users/profile.png') ?>" alt="user" class="rounded-circle" width="31">
                            </a>
                    ...
                    <ul id="sidebarnav">
                        <li class="sidebar-item active">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link active" href="index.html" aria-expanded="false">
                                <i class="mdi mdi-view-dashboard active"></i>
                                <span class="hide-menu active">Dashboard</span>
                            </a>
                        </li>
