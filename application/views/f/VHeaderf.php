...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url('assets/flexy/assets/images/favicon.png') ?>">
    <!-- Custom CSS -->
    <link href="<?php echo base_url('assets/flexy/assets/libs/chartist/dist/chartist.min.css') ?>" rel="stylesheet">
    <link href="<?php echo base_url('assets/flexy/assets/libs/chartist-plugin-tooltips/dist/chartist-plugin-tooltip.css') ?>" rel="stylesheet">
    <!-- Custom CSS -->
    <link href="<?php echo base_url('assets/flexy/dist/css/style.min.css') ?>" rel="stylesheet">
