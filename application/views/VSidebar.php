    ...
    <aside class="sidenav bg-secondary navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
                <img src="<?php echo base_url('assets/argon/img/logo-ct-dark.png') ?>" class="navbar-brand-img h-100" alt="main_logo">
        ...
        <div class="collapse navbar-collapse " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                <a class="nav-link <?php echo $this->uri->segment(1) == 'CCategory' ? 'active' : '' ?>" href="<?php echo base_url('CCategory') ?>">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                <a class="nav-link <?php echo $this->uri->segment(1) == 'CWork' ? 'active' : '' ?>" href="<?php echo base_url('CWork') ?>">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                <a class="nav-link <?php echo $this->uri->segment(1) == 'CPost' ? 'active' : '' ?>" href="<?php echo base_url('CPost') ?>">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                <a class="nav-link <?php echo $this->uri->segment(1) == 'CHome' ? 'active' : '' ?>" href="<?php echo base_url('CHome') ?>">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="<?php echo base_url('CHome/blog') ?>">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item">
                    <a class="nav-link " href="<?php echo base_url('CHome/works') ?>">
                        <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
